...
export function newProject() {
  ...
  return {
    ...
    render: {
      ...
      negative_prompt:
        "headless, missing head, missing face, cropped head, mannequin, skeleton, doll, robot, metallic body, cropped body, close-up, headshot, distorted anatomy, duplicate limbs, plastic skin, oversharpened",
      seed: 184627,
      width: 768,
      height: 1024,
      denoise: 0.55,
